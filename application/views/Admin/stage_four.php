<?php 
$order_information = $bill_of_material = $stage_one_pmpr = $stage_one_mpr = $f_g_transfer_note = $mrec = $fgrec = $qaar = $employee = $fn= $qcp_files = $qap_files = NULL;
...
$batchorlotlist = array();
$batchorlotlist[] = '<option value="">Select Batch/Lot</option>';
foreach($batchorlot_list->result_array() as $batchorlot){
    $batchorlotlist[] = '<option>'.$batchorlot['batchorlot'].'</option>';
}
$batchorlotlist = implode('',$batchorlotlist);
...
.form-container button:hover {
        ...
        <div class="col-sm-12">
            ...
            <div class="form-container">
                <form id="stage_one_order_form" enctype="multipart/form-data">
                    <input type="hidden"  id="stage" name="stage" value="stage_4">
                ...
                <div class="row">    
                    <div class="col-sm-6">
                        <label>DHR #</label>
                        <input type="text" name="dhr" id="dhr" value="<?=$order_information['dhr']?>" class="form-control" required <?=($user_privilage_list['dhr']['read']==1)?'readonly':''?>>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" for="stage_one_order_form" title="Save Order Information" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <table class="table table-responsive" id="billofmaterial" style="width:100%;padding:0px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:7.14%;">3s trans. qty.</th>
                                     <th style="width:7.14%;">Ordered Qty.</th>
                                    <th style="width:7.14%;">Extra %</th>
                                    <th style="width:7.14%;">Quantity Required</th>
                                    <th style="width:7.14%;">Quantity Issued</th>
                                    <th style="width:7.14%;">QIR #</th>
                                    <th style="width:15%;">Item Lot # (Input Lot)</th>
                        ...
                        <?php  $i=1; foreach($stage_one_dhr_bill_of_material->result_array() as $bill_of_material){ ?>
                                ...
                                <tr>
                                    <th><input type="hidden" name="last_stage_three_product[]" id="last_stage_three_product<?=$i?>" value="<?=$bill_of_material['last_stage_three_product']?>"><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="<?=$bill_of_material['item_number']?>" id="item_number<?=$i?>" onchange="fetch_stage_three_bom_details(this,<?=$i?>)" class="form-control" <?=($user_privilage_list['item_number']['read']==1)?'readonly':''?>></th>
                                    ...
                                    <th><input style="padding-left:0px;padding-right:0px;" type="text" name="uom[]" value="<?=$bill_of_material['uom']?>" id="uom<?=$i?>" class="form-control" <?=($user_privilage_list['uom']['read']==1)?'readonly':''?>></th>
                                     <th><input style="padding-left:0px;padding-right:0px;" type="number"  name="last_quantity_transfered[]" value="<?=$bill_of_material['last_quantity_transfered']?>"  id="last_quantity_transfered<?=$i?>" class="form-control" <?=($user_privilage_list['last_quantity_transfered']['read']==1)?'readonly':''?>></th>
                                    <th><input style="padding-left:0px;padding-right:0px;" type="number"  name="actual_quantity_required[]" value="<?=$bill_of_material['actual_quantity_required']?>" onchange="calculate_orderdered_quantity(); calculate_extra_quantity(<?=$i?>);" id="actual_quantity_required<?=$i?>" class="form-control" <?=($user_privilage_list['actual_quantity_required']['read']==1)?'readonly':''?>></th>
                                    <th>
                                        <input 
                                                style="padding-left:0px;padding-right:0px;" 
                                                type="number" 
                                                name="extra_quantity_required_percentage[]" 
                                                value="<?=$bill_of_material['extra_quantity_required_percentage']==''?0:$bill_of_material['extra_quantity_required_percentage']?>" 
                                                id="extra_quantity_required_percentage<?=$i?>" 
                                                onchange="calculate_extra_quantity(<?=$i?>)"
                                                class="form-control"
                                                 <?=($user_privilage_list['extra_quantity_required_percentage']['read']==1)?'readonly':''?>>
                                    </th>
                                    <th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_required[]" value="<?=$bill_of_material['quantity_required']?>"  id="quantity_required<?=$i?>" class="form-control" <?=($user_privilage_list['quantity_required']['read']==1)?'readonly':''?>></th>
                                    <th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_issued[]" value="<?=$bill_of_material['quantity_issued']?>"  id="quantity_issued<?=$i?>" class="form-control"  <?=($user_privilage_list['quantity_issued']['read']==1)?'readonly':''?>></th>
                                    ...
                                    <th>
                                        <?php if($bill_of_material['last_stage_three_product']==1){ ?>
                                            <select  name="item_lot_number[]" id="item_lot_number<?=$i?>" onchange="get_stagethree_lot_transfered_qnatity(this,<?=$i?>)" class="form-control"  <?=($user_privilage_list['item_lot_number']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>>
                                                <option value="">Select Batch/Lot</option>
                                                <?php foreach($batchorlot_list->result_array() as $batchorlot){ if(strtoupper(str_replace('_HD','',$bill_of_material['item_number']))==strtoupper($batchorlot['itemcode'])){ ?>
                                                    <option  <?=$batchorlot['batchorlot']==$bill_of_material['item_lot_number']?'selected':''?>><?=$batchorlot['batchorlot']?></option>
                                                <?php }}?>
                                     
                                            </select>
                                        <?php }else{ ?>
                                            <input  name="item_lot_number[]" id="item_lot_number<?=$i?>" onchange="get_stagethree_lot_transfered_qnatity(this,<?=$i?>)" value="<?=$bill_of_material['item_lot_number']?>" class="form-control" placeholder="Input Batch/Lot" <?=($user_privilage_list['item_lot_number']['read']==1)?'readonly':''?>>
                                        <?php } ?>
                                    </th>
                                    <th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Save Bill Of Material" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-container">
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-responsive" id="premanufacturingprocesstable" width="100%">
                            <thead>
                                <tr>
                                    <th style="width:<?=round(60/9)?>%">Item #</th>
                                    <th style="width:40%">Description</th>
                                    <th style="width:<?=round(60/9)?>%">UOM</th>
                                    <th style="width:<?=round(60/9)?>%">Qunatity</th>
                                    <th style="width:<?=round(60/9)?>%">WI #</th>
                                    <th style="width:<?=round(60/9)?>%">Equipment #</th>
                                    <th style="width:<?=round(60/9)?>%">Done By</th>
                                    <th style="width:<?=round(60/9)?>%">Verified By</th>
                                    <th style="width:<?=round(60/9)?>%">Date</th>
                                    <th style="width:<?=round(60/9)?>%"><button type="button" onclick="add_premprocess_row()" title="Add the Pre-Manufacturing Process item"class="btn btn-success btn-flat"  <?=($user_privilage_list['add_premprocess_row']['read']==1)?'hidden':''?>><i class="fa fa-plus"></i></button></th>
                                </tr>
                            </thead>
                            <tbody>
                        
                        <?php   $prmp_i =1; foreach($stage_one_pre_manufacturing_process->result_array() as $stage_one_pmpr){ ?>
                                   
                                <tr>
                                    <th><input type="number" name="prmp_item_number[]"        id="prmp_item_number<?=$prmp_i?>"         value="<?=$stage_one_pmpr['prmp_item_number']?>"        class="form-control" onchange="get_premp_process_description(<?=$prmp_i?>)" <?=($user_privilage_list['prmp_item_number']['read']==1)?'readonly':''?>></th>
                                    <th><input type="text" name="prmp_item_description[]"   id="prmp_item_description<?=$prmp_i?>"    value="<?=$stage_one_pmpr['prmp_item_description']?>"   class="form-control"  <?=($user_privilage_list['prmp_item_description']['read']==1)?'readonly':''?>></th>
                                    <th><input type="text" name="prmp_uom[]"                id="prmp_uom<?=$prmp_i?>"                 value="<?=$stage_one_pmpr['prmp_uom']?>"                class="form-control" <?=($user_privilage_list['prmp_uom']['read']==1)?'readonly':''?>></th>
                                    <th><input type="text" name="prmp_qunatity[]"           id="prmp_qunatity<?=$prmp_i?>"            value="<?=$stage_one_pmpr['prmp_qunatity']?>"           class="form-control" <?=($user_privilage_list['prmp_qunatity']['read']==1)?'readonly':''?>></th>
                                    <th><input type="text" name="prmp_wi_number[]"          id="prmp_wi_number<?=$prmp_i?>"           value="<?=$stage_one_pmpr['prmp_wi_number']?>"          class="form-control" <?=($user_privilage_list['prmp_wi_number']['read']==1)?'readonly':''?>></th>
                                    <th><select name="prmp_equipment_number[]"   id="prmp_equipment_number<?=$prmp_i?>"    value="<?=$stage_one_pmpr['prmp_equipment_number']?>"   class="form-control"  <?=($user_privilage_list['prmp_equipment_number']['read']==1)?'readonly':''?>><option value="">Select Euipment</option></select></th>
                                    <th><input type="text" name="prmp_done_by[]" id="prmp_done_by<?=$prmp_i?>" value="<?=$stage_one_pmpr['prmp_done_by']?>" class="form-control" <?=($user_privilage_list['prmp_done_by']['read']==1)?'readonly':''?>></th>
                                    <th>
                                        <select name="prmp_verified_by[]" id="prmp_verified_by<?=$prmp_i?>" class="form-control" <?=($user_privilage_list['prmp_verified_by']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>>
                                    ...
                                    <th><input type="date" name="prmp_date[]" id="prmp_date<?=$prmp_i?>" value="<?=$stage_one_pmpr['prmp_date']?>" class="form-control" <?=($user_privilage_list['prmp_date']['read']==1)?'readonly':''?>></th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" title="Save Pre-Manufacturing Process" class="btn btn-success">SAVE</button>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">        
            <div class="form-container">
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php $mp_i=1;  foreach($stage_one_manufacturing_process->result_array() as $stage_one_mpr){ ?>
                                ...
                                <tr>
                                    ...
                                    <th><select style="padding-left:0px;padding-right:0px;"  name="mp_equipment_number[]" id="mp_equipment_number<?=$mp_i?>" class="form-control"  <?=($user_privilage_list['mp_equipment_number']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>><option><?=$stage_one_mpr['mp_equipment_number']?></select></select></th>
                                    <th>
                                    ...
                                    <th>
                                        <input type="text" style="padding-left:0px;padding-right:0px;" name="mp_done_by[]" id="mp_done_by<?=$mp_i?>" value="<?=$stage_one_mpr['mp_done_by']?>" class="form-control" <?=($user_privilage_list['mp_done_by']['read']==1)?'readonly':''?>>
                                    ...
                                    <th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_remarks[]" id="mp_remarks<?=$mp_i?>" value="<?=$stage_one_mpr['mp_remarks']?>"  class="form-control" <?=($user_privilage_list['mp_remarks']['read']==1)?'readonly':''?>></th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Save Manufacturing Process" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php  $postmp_i=1; foreach($stage_one_post_manufacturing_process->result_array() as $stage_one_pompr){ ?>
                                ...
                                <tr>
                                    <th><input style="padding-left:0px;padding-right:0px;" type="number" name="pmp_seq_number[]" id="pmp_seq_number<?=$postmp_i?>" value="<?=$stage_one_pompr['pmp_seq_number']?>" class="form-control"  onchange="get_postmp_process_description(<?=$postmp_i?>)" <?=($user_privilage_list['pmp_seq_number']['read']==1)?'readonly':''?>></th>
                                    ...
                                    <th>
                                        <input type="text" style="padding-left:0px;padding-right:0px;" name="pmp_done_by[]" id="pmp_done_by<?=$postmp_i?>" class="form-control" value="<?=$stage_one_pompr['pmp_done_by']?>" <?=($user_privilage_list['pmp_done_by']['read']==1)?'readonly':''?>>
                                        <!--<select style="padding-left:0px;padding-right:0px;" name="pmp_done_by[]" id="pmp_done_by<?=$postmp_i?>" class="form-control" <?=($user_privilage_list['pmp_done_by']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>>-->
                                    ...
                                    <th>
                                        <select style="padding-left:0px;padding-right:0px;" name="pmp_checked_by[]" id="pmp_checked_by<?=$postmp_i?>" class="form-control" <?=($user_privilage_list['pmp_checked_by']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Save Post Manufacturing Process" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">        
            <div class="form-container">
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php   foreach($stage_one_qcp_files->result_array() as $qcp_files);
                                ...
                                <tr>
                                    ...
                                    <th><select name="qcp_scanned_file[]" id="qcp_scanned_file<?=$qcp_i?>" class="form-control" style="width:50px;padding:0px;" <?=($user_privilage_list['qcp_scanned_file']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>><option value="0" <?=$qcpr['qcp_scanned_file']==0?'selected':''?>>&#10060;</option><option value="1" <?=$qcpr['qcp_scanned_file']==1?'selected':''?>>&#x2714;</option></select></th>
                 ...
                 <div class="row">
                    ...
                    <?php if(file_exists($qcp_files['scanned_file'])){ ?>
                        <div class="col-sm-4" id="scanfiledata">
                           ...
                           <a href="<?=base_url($qcp_files['scanned_file'])?>" target="_blank"  class="btn btn-success " > <i class="fa fa-eye">  <?=$fullpath[count($fullpath)-1]?></i></a><span class="btn btn-danger" onclick="deleteqcscannedfile(<?=$qcp_files['dhr_id']?>,'<?=$qcp_files['scanned_file']?>','QC')"><i class="fa fa-trash"></i></span>
                        </div>
                    <?php } ?>
                </div>   
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Save Quality Control Process" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">        
            ...
            <input type="hidden" class="dhr_id" name="dhr_id" value="<?=$order_information['id']?>">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Save Finished Goods Transfer Note" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form></div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">         
            ...
            <input type="hidden" class="dhr_id" name="dhr_id" value="<?=$order_information['id']?>">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="button" onclick="copy_from_bom_to_mrec_row()"  title="Copy Material From BOM" class="btn btn-success btn-flat"><i class="fa fa-copy"></i></button>
                        <table class="table table-responsive" id="materialreconciliation" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><button type="button" onclick="add_mrec_row()"  title="Add Material Reconciliation Item" class="btn btn-success btn-flat" <?=($user_privilage_list['add_mrec_row']['read']==1)?'hidden':''?>><i class="fa fa-plus"></i></button></th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Material Reconciliation" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
            ...
            <input type="hidden" class="dhr_id" name="dhr_id" value="<?=$order_information['id']?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" name="control_samples_quantity" id="control_samples_quantity" value="<?=$fgrec['control_samples_quantity']?>" class="form-control" onkeyup="archive_quantity_reduce()"  <?=($user_privilage_list['archive_samples_quantity']['read']==1)?'readonly':''?>>
                    </div>
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-3">
                        ...
                        <input type="number" name="yield_percentage" id="yield_percentage" value="<?=$fgrec['yield_percentage']?>" class="form-control" readonly>
                    </div>
                     <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Finished Goods Reconciliation"  class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">   
         ...
         <?php
         foreach($stage_one_qap_files->result_array() as $qap_files);
         
         foreach($stage_one_qa_approval_and_release->result_array() as $qaar);
         ?>
            ...
            <input type="hidden" class="dhr_id" name="dhr_id" value="<?=$order_information['id']?>">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-sm-4 col-sm-offset-4">
                        <label>COA Scanned File Upload</label>
                        <input type="file" name="cc_scanned_pdf_file" id="cc_scanned_pdf_file"  class="form-control">
                    </div>
                    <?php if(file_exists($qap_files['scanned_file'])){ ?>
                        <div class="col-sm-4" id="scanfiledata">
                            <?php $fullpath=explode('/',$qap_files['scanned_file']);?>
                           <a href="<?=base_url($qap_files['scanned_file'])?>" target="_blank"  class="btn btn-success " > <i class="fa fa-eye">  <?=$fullpath[count($fullpath)-1]?></i></a><span class="btn btn-danger" onclick="deleteqcscannedfile(<?=$qap_files['dhr_id']?>,'<?=$qap_files['scanned_file']?>','QA')"><i class="fa fa-trash"></i></span>
                        </div>
                    <?php } ?>
                </div>   
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center><button type="submit" title="Save QA Approval and Release" class="btn btn-success">SAVE</button></center>
                    </div>
                </div>
            </form>
            </div>
    ...
    <div id="printstagefour" style="position:fixed;bottom:40px;width:300px;z-index:12050;">
            <center>
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <button type="button" id="printstagefourdhrpdf" target="blank" style="width:150px;z-index:12050;"  class="btn btn-primary">STAGE-4 PDF</button>
                        </td>
                    </tr>
                </table>
            </center>
...
//var batchorlotlist='<?=$batchorlotlist?>';
 
////stage_one_order_form
    $('#stage_one_order_form').submit(function(e){
        e.preventDefault();
        if(1){ //confirm('are you want to save this record?')
            $.ajax({
                type:'post',
    ...
    $('#itemcode').change(function(){
        $.ajax({
                type:'post',
                url:'<?=base_url("AdminController/stage_four_get_item_description")?>',
                ...
                success:function(responsedata){
                   ...
                   responsedata['bom_details'].forEach(item=>{
                      var batchorlotlist='<option value="">Select Lot Number</option>';
                      var lots = responsedata['stage_two_lot_details'][(item['raw_material_or_ingredient'].replace("_HD","")).toUpperCase()];
                        var bt = '';
                        let stagethreeproduct=0;
                        if(typeof lots !== "undefined"){
                            lots.forEach(function(value,index){
                                batchorlotlist += '<option>'+value+'</option>';
                            });
                          
                            bt = '<th><select style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" id="item_lot_number'+i+'" onchange="get_stagethree_lot_transfered_qnatity(this,'+i+')"  class="form-control">'+batchorlotlist+'</select></th>';
                            stagethreeproduct=1;
                        }else{
                            bt = '<th><input style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+i+'"  class="form-control"></th>';
                            stagethreeproduct=0;
                        }
                        
                      var row='<tr>'+
                        '<th><input type="hidden" name="last_stage_three_product[]" id="last_stage_three_product'+i+'" value="'+stagethreeproduct+'"><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="'+item['raw_material_or_ingredient']+'" id="item_number'+i+'" onchange="fetch_stage_three_bom_details(this,'+i+')" class="form-control" ></th>'+
                        ...
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="uom[]" value="'+item['uom']+'" id="uom'+i+'" class="form-control"></th>'+
                         '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="last_quantity_transfered[]" value="0"  id="last_quantity_transfered'+i+'" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="actual_quantity_required[]" value="0"  id="actual_quantity_required'+i+'" onchange="calculate_orderdered_quantity(); calculate_extra_quantity('+i+');" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number" name="extra_quantity_required_percentage[]" value="0" id="extra_quantity_required_percentage'+i+'" onchange="calculate_extra_quantity('+i+')" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_required[]" value="0"  id="quantity_required'+i+'" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_issued[]" value=""  id="quantity_issued'+i+'" class="form-control"></th>'+
    ...
    function calculate_orderdered_quantity(){ 
        ...
        let each_quantity_required = [];
        let each_uom = [];
        
        let each_mrec_quantity_received = [];
        let each_mrec_uom = [];
        
        
        let last_stage3_product = [];
        $('input[name="last_stage_three_product[]"]').each(function(){
            last_stage3_product.push($(this).val());
        });
        
        
        $('input[name="actual_quantity_required[]"]').each(function(){
            each_quantity_required.push($(this).val());
        });
       
        let i=0;
        each_quantity_required.forEach(function(item,index){
            if(last_stage3_product[i]==1){
            let quantity_issued       = parseFloat(item);
                quantity_issued   = isNaN(quantity_issued)?0:quantity_issued; 
           
            order_quantity      += quantity_issued;
            }
            i++;
        }); 
        
        //This material reconcillation quantity is not get subtract in ordered quantity for this 4th stage only.
        // i=0;
        
        // $('input[name="mrec_quantity_received[]"]').each(function(){
        //     each_mrec_quantity_received.push($(this).val());
        // });
       
        // $('input[name="mrec_quantity_received[]"]').each(function(){
        //     let quantity_received       = parseFloat(each_mrec_quantity_received[i]);
        //         quantity_received       = isNaN(quantity_received)?0:quantity_received; //required bom quantity
                 
        //     order_quantity      -= quantity_received;
        //     i++;
        // }); 
...
////stage_one_bill_of_material_form   
    ...
    function add_dhr_bill_item_row(){
        var batchorlotlist='';
        var row='<tr>'+
                        '<th><input type="hidden" name="last_stage_three_product[]" id="last_stage_three_product'+i+'" value="0"><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="" id="item_number'+i+'" onchange="fetch_stage_three_bom_details(this,'+i+')" class="form-control" ></th>'+
                        ...
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number" name="quantity_issued[]" value="" id="quantity_issued'+i+'" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="qir_number[]" value="" id="qir_number'+i+'" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+i+'"  class="form-control"></th>'+
    ...
    function get_stagethree_lot_transfered_qnatity(lot,bom_i){
        $.ajax({
            type:'post',
            url:'<?=base_url("AdminController/get_stagethree_lot_transfered_qnatity")?>',
            data:{
                batchorlot:lot.value,
                currentdhr:$('#dhr').val(),
            },
            dataType:'json',
            success:function(data){
                $('#last_quantity_transfered'+bom_i).val(data['transferred_quantity']);
                
                var extra_percentage = parseFloat($('#extra_quantity_required_percentage'+bom_i).val());
                var actual_quantity_required = parseFloat($('#actual_quantity_required'+bom_i).val());
                
                var include_percentage=actual_quantity_required + (actual_quantity_required*(extra_percentage/100))
                $('#quantity_required'+bom_i).val(include_percentage);
                $('#qir_number'+bom_i).val(data['qir_number']);
            }
        });
     }
     
      function fetch_stage_three_bom_details(bom_item_code,bom_i){
         $.ajax({
            type:'post',
            url:'<?=base_url("AdminController/get_stage_three_bom_details")?>',
            data:{
                item_code:$('#itemcode').val(),
                bom_item_code:bom_item_code.value,
                currentdhr:$('#dhr').val(),
            },
            dataType:'json',
            success:function(data){
                var input = '<input style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+bom_i+'"  class="form-control">';
                var select = '<select style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+bom_i+'" onchange="get_stagethree_lot_transfered_qnatity(this,'+bom_i+')" class="form-control"><option value="">Select Batch/Lot No</option>';
                for(var i=0;i<data['stage_one_lot_details'].length;i++){
                    select+='<option>'+data['stage_one_lot_details'][i]+'</option>';
                }
                select+='</select>';
                
                $('#last_stage_three_product'+bom_i).val(data['stage_one_lot_details'].length>0?1:0);
                $('#item_description'+bom_i).val(data['bom_details']['bom_description']);
                $('#uom'+bom_i).val(data['bom_details']['uom']);
                if(data['stage_one_lot_details'].length>0){
                    $('#item_lot_number'+bom_i).replaceWith(select);
                }else{
                    $('#item_lot_number'+bom_i).replaceWith(input);
                }
            }
        });
     }
    ...
    function calculate_extra_quantity(bom_i){
        var extra_percentage    = parseFloat($('#extra_quantity_required_percentage'+bom_i).val());
        var actual_quantity     = parseFloat($('#actual_quantity_required'+bom_i).val());
        var include_percentage  = actual_quantity+(actual_quantity*(extra_percentage/100))
        $('#quantity_required'+bom_i).val(Math.round(include_percentage));
    }
...
////stage_one_pre_manufacturing_process_form     
   ...
   var prmp_i='<?=$prmp_i?>';
    function add_premprocess_row(){
        var row = '<tr>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="number" name="prmp_item_number[]" id="prmp_item_number'+prmp_i+'" value="" onchange="get_premp_process_description('+prmp_i+')" class="form-control"></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="prmp_item_description[]" id="prmp_item_description'+prmp_i+'" value="" class="form-control"></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="prmp_uom[]" id="prmp_uom'+prmp_i+'" value="" class="form-control"></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="prmp_qunatity[]" id="prmp_qunatity'+prmp_i+'" value="" class="form-control"></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="prmp_wi_number[]" id="prmp_wi_number'+prmp_i+'" value="" class="form-control"></th>'+
                    '<th><select style="padding-left:0px;padding-right:0px;" type="text" name="prmp_equipment_number[]" id="prmp_equipment_number'+prmp_i+'" class="form-control"><option value="">Select Equipment</option></select></th>'+
                    '<th><input type="text" style="padding-left:0px;padding-right:0px;"  name="prmp_done_by[]" id="prmp_done_by'+prmp_i+'" class="form-control"></th>'+
                    '<th><select style="padding-left:0px;padding-right:0px;"  name="prmp_verified_by[]" id="prmp_verified_by'+prmp_i+'" class="form-control"><option value="">select verified_by</option>'+departmentemployees[15]+'</select></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="date" name="prmp_date[]" id="prmp_date'+prmp_i+'" value="" class="form-control"></th>'+
    ...
    function get_premp_process_description(mp_i){
        $.ajax({
                type:'post',
                url:'<?=base_url("AdminController/get_premp_process_description")?>',
                data:{
                    mp_seq_number   : $('#prmp_item_number'+mp_i).val(),
                    stage           : $('#stage').val(),
                },
                dataType:'json',
                success:function(data){
                    $('#prmp_item_description'+mp_i).val(data['process_description']);
                    $('#prmp_wi_number'+mp_i).val(data['wi_number']);
                    ...
                    for(var i=0;i<data['mp_equipment_number'].length;i++){
                     ...
                     $('#prmp_equipment_number'+mp_i).html(quipment);
                }
            });
    }
//
...
////stage_one_manufacturing_process_form     
    ...
    function add_mprocess_row(){
       ...
       var row = '<tr>'+
                    ...
                    '<th><select style="padding-left:0px;padding-right:0px;" name="mp_equipment_number[]" id="mp_equipment_number'+mp_i+'" class="form-control"><option value="">Select Euipment</option></select></th>'+
                    ...
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_remarks[]" id="mp_remarks'+mp_i+'" value=""  class="form-control"></th>'+
    ...
    function sum_mp_good_quantity(mp_i){
        ...
        $('#mp_manufactured_qunatity'+mp_i).val(mp_rejected_qunatity+mp_good_qunatity);
        ...
        let mp_manufactured_qunatity_sum =0;
        mppi=0;
        $('.mp_manufactured_qunatity').each(
            function(){
                const value=parseFloat($(this).val());
                if(!isNaN(value)){
                    if(mp_seq_numbers_value[mppi]==7){
                        mp_manufactured_qunatity_sum+=value;
                    }
                }
            mppi++;
        });
        ...
        $('#production_quantity').val(mp_manufactured_qunatity_sum);
        ...
        let transferred_quantity = $('#transferred_quantity').val();
        let percentage = (transferred_quantity/mp_manufactured_qunatity_sum)*100;
         let rejectpercentage = (mp_rejected_produt_sum/mp_manufactured_qunatity_sum)*100;
...
////stage_one_post_manufacturing_process_form     
   ...
   var postmp_i='<?=$postmp_i?>';
    function add_pmprocess_row(){
        var row = ' <tr>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number" name="pmp_seq_number[]"  id="pmp_seq_number'+postmp_i+'"value="" onchange="get_postmp_process_description('+postmp_i+')" class="form-control"></th>'+
                        ...
                        '<th><select style="padding-left:0px;padding-right:0px;"  name="pmp_checked_by[]" id="pmp_checked_by'+postmp_i+'"  class="form-control"><option value="">select checked_by</option>'+departmentemployees[14]+'</select></th>'+
    ...
    function delete_pmprocess_row(tr){
     ...
     function get_postmp_process_description(mp_i){
        $.ajax({
                type:'post',
                url:'<?=base_url("AdminController/get_postmp_process_description")?>',
                data:{
                    mp_seq_number   : $('#pmp_seq_number'+mp_i).val(),
                    stage           : $('#stage').val(),
                },
                dataType:'json',
                success:function(data){
                    $('#pmp_process_description'+mp_i).val(data['process_description']);
                    $('#pmp_wi_number'+mp_i).val(data['wi_number']);
...
////stage_one_quality_control_process_form     
    ...
    function add_qcprocess_row(){
        var row = '<tr>'+
                    ...
                    '<th><select name="qcp_verified_by[]" id="qcp_verified_by'+qcp_i+'"  class="form-control"><option>Select verified by</option>'+departmentemployees[14]+'</th>'+
    ...
    function delete_qcprocess_row(tr){
     ...
     function deleteqcscannedfile(dhr_id,file_path,from_where){
        $.ajax({
                type:'post',
...
////stage_one_material_reconciliation_form     
    ...
    var mrec_i = '<?=$mrec_i?>';
     function add_mrec_row(){
        var row = '<tr>'+
                    '<th><input type="hidden" name="mrec_last_stage_three_product[]" id="mrec_last_stage_three_product'+mrec_i+'" value="0"><input type="text" name="mrec_item_number[]" id="mrec_item_number'+mrec_i+'" value="" class="form-control"></th>'+
    ...
    function copy_from_bom_to_mrec_row(){
        $('#billofmaterial tbody tr').each(function(){
            let mrec_last_stage_three_product = $(this).find('th').eq(0).find('input[type="hidden"]').val();
            ...
            var row = '<tr>'+
                    '<th><input type="hidden" name="mrec_last_stage_three_product[]" id="mrec_last_stage_three_product'+mrec_i+'" value="'+mrec_last_stage_three_product+'"><input type="text" name="mrec_item_number[]" id="mrec_item_number'+mrec_i+'" value="'+mrec_item_number+'" class="form-control"></th>'+
...
// 
 ...
 ////stage_one_finished_goods_reconciliation_form     
    ...
    function archive_quantity_reduce(){
        $pq    = parseFloat($('#total_quantity_produced_and_packed').val());
        $pasq  = parseFloat($('#control_samples_quantity').val());
        $pq    = isNaN($pq)?0:$pq;
        $pasq = isNaN($pasq)?0:$pasq;
        $('#transferred_quantity').val($pq-($pasq));
        $('#quantity_released_for_dispatch').val($pq-($pasq));
    }
 // 
...
////stage_one_footer_note     
 ...
 // 
  ...
  async function saveallforms(){
      if(confirm('Are you want to save the all forms?')){
        try{
    ...
    $('#printstagefourdhrpdf').click(function(){ 
        window.open("<?=base_url('ShahPDF/stage_four_form/')?>"+$('.dhr_id').val(),"BLANK");
    });

<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-list"></i> Stage-3 Device History Record List</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Stage-3 DHR List</a></li>
        </ul>
      </div>
      <div class="row">
...
<script>
    function adddhrecords(id){
         $.ajax({
             type:'post',
             url:baseurl+'AdminController/LoadStageThreeForm',
             data:{dhr_id:id},

<?php 
$order_information = $bill_of_material = $stage_one_pmpr = $stage_one_mpr = $f_g_transfer_note = $mrec = $fgrec = $qaar = $employee = $fn = $qcp_files = NULL;
...
.form-container button:hover {
        ...
        <div class="col-sm-12">
            ...
            <div class="form-container">
                <form id="stage_one_order_form" enctype="multipart/form-data">
                    <input type="hidden"  id="stage" name="stage" value="stage_3">
                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="table table-responsive" id="billofmaterial" style="width:100%;padding:0px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:7.14%;">2s trans. qty.</th>
                        ...
                        <?php  $i=1; foreach($stage_one_dhr_bill_of_material->result_array() as $bill_of_material){ ?>
                                ...
                                <tr>
                                    ...
                                    <th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_issued[]" value="<?=$bill_of_material['quantity_issued']?>" onchange="calculate_orderdered_quantity()" id="quantity_issued<?=$i?>" class="form-control" <?=($user_privilage_list['quantity_issued']['read']==1)?'readonly':''?>></th>
                                    ...
                                    <th>
                                        <select  name="item_lot_number[]" id="item_lot_number<?=$i?>" onchange="get_stagetwo_lot_transfered_qnatity(this,<?=$i?>)" class="form-control" <?=($user_privilage_list['item_lot_number']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>>
                        ...
                        <?php   $prmp_i =1; foreach($stage_one_pre_manufacturing_process->result_array() as $stage_one_pmpr){ ?>
                                ...
                                <tr>
                                    ...
                                    <th><select name="prmp_equipment_number[]"   id="prmp_equipment_number<?=$prmp_i?>"    value="<?=$stage_one_pmpr['prmp_equipment_number']?>"   class="form-control" <?=($user_privilage_list['prmp_equipment_number']['read']==1)?'readonly':''?>><option value="">Select Euipment</option></select></th>
                                     <th><input type="text" name="prmp_done_by[]" id="prmp_done_by<?=$prmp_i?>" class="form-control" value="<?=$stage_one_pmpr['prmp_done_by']?>" <?=($user_privilage_list['prmp_done_by']['read']==1)?'readonly':''?>></th>
                                   <th>
    ...
    <div class="row">
        <div class="col-sm-12">        
            <div class="form-container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-responsive" id="manufacturingprocess" width="100%"  style="padding:0px;">
                            <thead>
                                <tr>
                        ...
                        <?php $mp_i=1;  foreach($stage_one_manufacturing_process->result_array() as $stage_one_mpr){ ?>
                                ...
                                <tr>
                                    ...
                                    <th><select style="padding-left:0px;padding-right:0px;" name="mp_equipment_number[]" id="mp_equipment_number<?=$mp_i?>"  class="form-control" <?=($user_privilage_list['mp_equipment_number']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>><option><?=$stage_one_mpr['mp_equipment_number']?></option></select></th>
                                    <th>
                                    ...
                                    <th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_rejected_qunatity[]" id="mp_rejected_qunatity<?=$mp_i?>" value="<?=$stage_one_mpr['mp_rejected_qunatity']?>" onblur="sum_mp_good_quantity(<?=$mp_i?>)" class="form-control mp_rejected_qunatity"></th>
                                    
                                    <th><input type="text" style="padding-left:0px;padding-right:0px;" name="mp_done_by[]" id="mp_done_by<?=$mp_i?>" value="<?=$stage_one_mpr['mp_done_by']?>" class="form-control" <?=($user_privilage_list['mp_done_by']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>></th>
                                    <th>
        ...
        <?php foreach($stage_one_finished_goods_reconcillation->result_array() as $fgrec); ?>
            ...
            <input type="hidden" class="dhr_id" name="dhr_id" value="<?=$order_information['id']?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <label>Penetration Samples Quantity</label>
                        <input type="number" name="penetration_samples_quantity"  id="penetration_samples_quantity" value="<?=$fgrec['penetration_samples_quantity']?>" class="form-control" onkeyup="archive_quantity_reduce()" <?=($user_privilage_list['penetration_samples_quantity']['read']==1)?'readonly':''?>>
                    </div>
                    <div class="col-sm-3">
                        <label>Control Samples Quantity</label>
                        <input type="number" name="control_samples_quantity" id="control_samples_quantity" value="<?=$fgrec['control_samples_quantity']?>" class="form-control" onkeyup="archive_quantity_reduce()" <?=($user_privilage_list['control_samples_quantity']['read']==1)?'readonly':''?>>
                    </div>
                    <div class="col-sm-2">
   ...
   <div id="printstagethree" style="position:fixed;bottom:40px;width:300px;z-index:12050;">
            <center>
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <button type="button" id="stagethreedhrprint" target="blank" style="width:150px;z-index:12050;"  class="btn btn-primary">STAGE-3 PDF</button>
                        </td>
                    </tr>
                </table>
            </center>
...
////stage_one_order_form
    ...
    $('#itemcode').change(function(){
        $.ajax({
                type:'post',
                url:'<?=base_url("AdminController/stage_three_get_item_description")?>',
                ...
                success:function(responsedata){
                   ...
                   responsedata['bom_details'].forEach(item=>{
                      ...
                      var row='<tr>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="'+item['raw_material_or_ingredient']+'" id="item_number'+i+'" onchange="fetch_stage_two_bom_details(this,'+i+')" class="form-control" ></th>'+
                        ...
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_issued[]" value="" onchange="calculate_orderdered_quantity()" id="quantity_issued'+i+'" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="qir_number[]" value="" id="qir_number'+i+'" class="form-control"></th>'+
                        '<th><select style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+i+'" onchange="get_stagetwo_lot_transfered_qnatity(this,'+i+')"  class="form-control">'+batchorlotlist+'</select></th>'+
    ...
    function calculate_orderdered_quantity(){
        ...
        //This material reconcillation is not subtracting from ordered quantity
        // i=0;
...
////stage_one_bill_of_material_form   
    ...
    function add_dhr_bill_item_row(){
        var batchorlotlist='';
        var row='<tr>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="" id="item_number'+i+'" onchange="fetch_stage_two_bom_details(this,'+i+')" class="form-control" ></th>'+
                        ...
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="actual_quantity_required[]" value="0"  id="actual_quantity_required'+i+'" onchange="calculate_orderdered_quantity(); calculate_extra_quantity('+i+');"  class="form-control"></th>'+
                         '<th><input style="padding-left:0px;padding-right:0px;" type="number" name="extra_quantity_required_percentage[]" value="0" id="extra_quantity_required_percentage'+i+'" onchange="calculate_extra_quantity('+i+')" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number"  name="quantity_required[]" value=""  id="quantity_required'+i+'" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="number" name="quantity_issued[]" value="" id="quantity_issued'+i+'" onchange="calculate_orderdered_quantity()" class="form-control"></th>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="qir_number[]" value="" id="qir_number'+i+'" class="form-control"></th>'+
                        '<th><select style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+i+'" onchange="get_stagetwo_lot_transfered_qnatity(this,'+i+')" class="form-control">'+batchorlotlist+'</select></th>'+
    ...
    function get_stagetwo_lot_transfered_qnatity(lot,bom_i){
        $.ajax({
            type:'post',
            url:'<?=base_url("AdminController/get_stagetwo_lot_transfered_qnatity")?>',
            data:{
     ...
     function fetch_stage_two_bom_details(bom_item_code,bom_i){
         $.ajax({
            type:'post',
            url:'<?=base_url("AdminController/get_stage_two_bom_details")?>',
            data:{
...
////stage_one_material_reconciliation_form     
    ...
    var mrec_i = '<?=$mrec_i?>';
     function add_mrec_row(){
        var row = '<tr>'+
                    '<th><input type="text" name="mrec_item_number[]" id="mrec_item_number'+mrec_i+'" value="" class="form-control"></th>'+
...
// 
 ...
 ////stage_one_finished_goods_reconciliation_form     
     ...
     function archive_quantity_reduce(){
         ...
         $easq  = parseFloat($('#penetration_samples_quantity').val());
         $pasq  = parseFloat($('#control_samples_quantity').val());
         
         $pq    = isNaN($pq)?0:$pq;
         $easq = isNaN($easq)?0:$easq;
         $pasq = isNaN($pasq)?0:$pasq;
         $('#transferred_quantity').val($pq-($easq+$pasq));
         $('#quantity_released_for_dispatch').val($pq-($easq+$pasq));
     }
 // 
...
////stage_one_footer_note     
 ...
 // 
    ...
    $('#stagethreedhrprint').click(function(){
        window.open("<?=base_url('ShahPDF/stage_three_form/')?>"+$('.dhr_id').val(),"BLANK");
    });

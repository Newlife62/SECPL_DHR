...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl"  onselectstart="return true" ondragstart="return false">
    ...
    <header class="app-header"><a class="app-header__logo" href="<?php echo base_url();?>UserController" style="font-family: times;"><?=TITTLE?></a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?php echo base_url()?>assets/image/admin.png" style="height:15%;width:15%; alt="User Image">
        <div>
      ...
      <ul class="app-menu">
         <li><a class="app-menu__item active" href="<?= base_url()?>UserController"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dash board</span></a></li>
        <li><a class="app-menu__item" href="<?=base_url()?>UserController/ShareLedger"><i class="app-menu__icon fa fa-file"></i><span class="app-menu__label">Share & Loan Ledger Report</span></a></li>
        ...
        <!--    <li><a class="treeview-item" href="<?=base_url()?>UserController/ShareLedger"><i class="icon fa fa-circle-o"></i> Share & Loan Ledger</a></li>-->
        <!--   </ul>-->
        <!--</li>      -->

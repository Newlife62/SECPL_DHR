...
.form-container button:hover {
        ...
        <div class="col-sm-12">
            ...
            <div class="form-container">
                <form id="stage_one_order_form" enctype="multipart/form-data">
                    <input type="hidden"  id="stage" name="stage" value="stage_2">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="reference" id="reference" value="<?=$bill_of_material['reference']?>" class="form-control" <?=($user_privilage_list['reference']['read']==1)?'readonly':''?>>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <table class="table table-responsive" id="billofmaterial" style="width:100%;padding:0px;">
                            <thead>
                                <tr>
                                    ...
                                    <th><button type="button" onclick="add_dhr_bill_item_row()" title="Add BOM" class="btn btn-success btn-flat"><i class="fa fa-plus" <?=($user_privilage_list['add_dhr_bill_item_row']['read']==1)?'hidden':''?>></i></button></th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <?php  $i=1; foreach($stage_one_dhr_bill_of_material->result_array() as $bill_of_material){ ?>
                                ...
                                <tr>
                                    <th><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="<?=$bill_of_material['item_number']?>" id="item_number<?=$i?>" onchange="fetch_stage_one_bom_details(this,<?=$i?>)" class="form-control" <?=($user_privilage_list['item_number']['read']==1)?'readonly':''?> ></th>
                                    ...
                                    <th>
                                        <select  name="item_lot_number[]" id="item_lot_number<?=$i?>" onchange="get_stageone_lot_transfered_qnatity(this,<?=$i?>)" class="form-control" <?=($user_privilage_list['item_lot_number']['read']==1)?'onmousedown="event.preventDefault(); this.blur();" readonly':''?>>
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php $mp_i=1;  foreach($stage_one_manufacturing_process->result_array() as $stage_one_mpr){ ?>
                                ...
                                <tr>
                                    ...
                                    <th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_good_qunatity[]" id="mp_good_qunatity<?=$mp_i?>" value="<?=$stage_one_mpr['mp_good_qunatity']?>" onchange="sum_mp_good_quantity(<?=$mp_i?>)" class="form-control mp_good_qunatity" <?=($user_privilage_list['mp_good_qunatity']['read']==1)?'readonly':''?>></th>
                                    <th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_rejected_qunatity[]" id="mp_rejected_qunatity<?=$mp_i?>" value="<?=$stage_one_mpr['mp_rejected_qunatity']?>"  onchange="sum_mp_good_quantity(<?=$mp_i?>)" class="form-control mp_rejected_qunatity" <?=($user_privilage_list['mp_rejected_qunatity']['read']==1)?'readonly':''?>></th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php   foreach($stage_one_qcp_files->result_array() as $qcp_files);
                                $qcp_i=1; foreach($stage_one_quality_control_process->result_array() as $qcpr){ ?>
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php  $mrec_i=1; foreach($stage_one_material_reconciliation->result_array() as $mrec){ ?>
                                ...
                                <tr>
                                    ...
                                    <th><input type="text" name="mrec_qir_number[]" id="mrec_qir_number<?$mrec_i?>" value="<?=$mrec['mrec_qir_number']?>" class="form-control"></th>
        ...
        <?php foreach($stage_one_finished_goods_reconcillation->result_array() as $fgrec); ?>
            ...
            <input type="hidden" class="dhr_id" name="dhr_id" value="<?=$order_information['id']?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <label>EP Archive Samples Quantity</label>
                        <input type="number" name="ep_archive_samples_quantity"  id="ep_archive_samples_quantity" value="<?=$fgrec['ep_archive_samples_quantity']?>" class="form-control" onkeyup="archive_quantity_reduce()">
                    </div>
                    <div class="col-sm-3">
                        <label>Production Archive Samples Quantity</label>
                        <input type="number" name="production_archive_samples_quantity" id="production_archive_samples_quantity" value="<?=$fgrec['production_archive_samples_quantity']?>" class="form-control" onkeyup="archive_quantity_reduce()" <?=($user_privilage_list['archive_samples_quantity']['read']==1)?'readonly':''?>>
                    </div>
                    <div class="col-sm-2">
    ...
    <div id="printstagetwo" style="position:fixed;bottom:40px;width:300px;z-index:12050;">
            <center>
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <button type="button" id="stagetwodhrprint" target="blank" style="width:150px;z-index:12050;"  class="btn btn-primary">STAGE-2 PDF</button>
                        </td>
                    </tr>
                </table>
            </center>
...
////stage_one_order_form
    ...
    $('#itemcode').change(function(){
        $.ajax({
                type:'post',
                url:'<?=base_url("AdminController/stage_two_get_item_description")?>',
                ...
                success:function(responsedata){
                   ...
                   responsedata['bom_details'].forEach(item=>{
                      ...
                      var lots = responsedata['stage_one_lot_details'][item['raw_material_or_ingredient']];
                      ...
                      var row='<tr>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="'+item['raw_material_or_ingredient']+'" id="item_number'+i+'" onchange="fetch_stage_one_bom_details(this,'+i+')"  class="form-control" ></th>'+
                        ...
                        '<th><select style="padding-left:0px;padding-right:0px;" name="item_lot_number[]" value="" id="item_lot_number'+i+'" onchange="get_stageone_lot_transfered_qnatity(this,'+i+')"  class="form-control">'+batchorlotlist+'</select></th>'+
...
////stage_one_bill_of_material_form   
    ...
    function add_dhr_bill_item_row(){
        var batchorlotlist='';
        var row='<tr>'+
                        '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="item_number[]" value="" id="item_number'+i+'" onchange="fetch_stage_one_bom_details(this,'+i+')" class="form-control" ></th>'+
    ...
    function get_stageone_lot_transfered_qnatity(lot,bom_i){
        $.ajax({
            type:'post',
            url:'<?=base_url("AdminController/get_stageone_lot_transfered_qnatity")?>',
            data:{
            ...
            success:function(data){
                $('#quantity_required'+bom_i).val(data['transferred_quantity']);
                $('#qir_number'+bom_i).val(data['qir_number']);
            }
        });
     }
     
     function fetch_stage_one_bom_details(bom_item_code,bom_i){
         $.ajax({
            type:'post',
            url:'<?=base_url("AdminController/get_stage_one_bom_details")?>',
            data:{
...
////stage_one_manufacturing_process_form     
    ...
    function add_mprocess_row(){
       ...
       var row = '<tr>'+
                    ...
                    '<th><select style="padding-left:0px;padding-right:0px;"  name="mp_equipment_number[]" id="mp_equipment_number'+mp_i+'" class="form-control"></select></th>'+
                    ...
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_manufactured_qunatity[]" id="mp_manufactured_qunatity'+mp_i+'" value="" class="form-control mp_manufactured_qunatity" readonly></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_good_qunatity[]" id="mp_good_qunatity'+mp_i+'" value="0" onchange="sum_mp_good_quantity('+mp_i+')" class="form-control mp_good_qunatity" ></th>'+
                    '<th><input style="padding-left:0px;padding-right:0px;" type="text" name="mp_rejected_qunatity[]" id="mp_rejected_qunatity'+mp_i+'" value="0"  onchange="sum_mp_good_quantity('+mp_i+')" class="form-control mp_rejected_qunatity"></th>'+
                    '<th><input type="text" style="padding-left:0px;padding-right:0px;"  name="mp_done_by[]"  id="mp_done_by'+mp_i+'"  class="form-control"><option value=""></th>'+
    ...
    function sum_mp_good_quantity(mp_i){
        ...
        let percentage = (transferred_quantity/mp_manufactured_qunatity)*100;
...
// 
 ...
 ////stage_one_finished_goods_reconciliation_form     
     ...
     function archive_quantity_reduce(){
         ...
         $easq  = parseFloat($('#ep_archive_samples_quantity').val());
         $pasq  = parseFloat($('#production_archive_samples_quantity').val());
...
////stage_one_footer_note     
 ...
 async function saveallforms(){
    ...
    $('#stagetwodhrprint').click(function(){
        window.open("<?=base_url('ShahPDF/stage_two_form/')?>"+$('.dhr_id').val(),"BLANK");
    });
